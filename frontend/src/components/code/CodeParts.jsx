        ...
        {messages.length === 0 && (
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <div className="rounded-md border border-border p-2"><PlugZap className="w-3.5 h-3.5 text-primary mb-1" /> {providers?.openai?.configured || providers?.openrouter?.configured || providers?.nvidia?.configured ? "AI Models connected" : "Add AI model keys"}</div>
            </div>
