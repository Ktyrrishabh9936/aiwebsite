...
import { ArrowRight, Bot, Brain, MessageSquare, FileText, Search, Palette, BarChart3, UserCheck, Code2, Phone, RefreshCw, Loader2, Settings2, CalendarPlus } from "lucide-react";
...
const AGENTS = [
  ...
  { id: "follow-up", name: "AI Follow-up Agent", icon: CalendarPlus, group: "Workspace", role: "Suggests the next action to move an open lead toward conversion.", trigger: "When you choose Suggest with AI from a lead in CRM.", inputs: ["Pipeline stage and last response", "Call summary, qualification outcome and recent notes"], outputs: ["Editable follow-up action and reason", "Manual recommendation if AI is unavailable"], note: "Suggestions are drafts. A person saves the follow-up, contacts the lead and records the outcome. No automatic calls or messages are sent.", link: "crm?tab=reminders", action: "Open follow-ups", context: "Lead history + stage → Next action" },
