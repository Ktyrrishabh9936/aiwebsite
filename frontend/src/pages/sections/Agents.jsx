...
const AGENTS = [
  ...
  { id: "qualification", name: "Lead Qualification", icon: UserCheck, group: "Workspace", role: "Applies product rules to call facts and updates CRM qualification.", trigger: "When Plivo sends a call result, transcript or recording callback.", inputs: ["Call events and conversation facts", "Product profile, mandatory rules and retry policy"], outputs: ["Call outcome, lead status, score and temperature", "Missing information, follow-up tasks and retry schedule"], note: "Plivo conducts calls. AI extracts facts; application rules decide qualification. View outcomes inside each CRM lead.", link: "qualification", action: "Configure qualification", context: "Call facts + product rules ? CRM decision" },
